  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        ...
        sans: ["GeneralSans", "Poppins", "sans-serif"],
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      boxShadow: {
        ...
        "card-hover": "0 20px 40px rgba(43,43,43,0.15)",
        gold: "0 8px 20px rgba(212,160,23,0.4)",
        red: "0 8px 20px rgba(158,42,43,0.3)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
        ...
        "slide-down": {
          ...
          to: { opacity: "1", maxHeight: "400px", transform: "translateY(0)" },
        },
      },
      animation: {
